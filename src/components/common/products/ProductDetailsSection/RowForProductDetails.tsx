    ...
    <div className="py-[30px] px-[24px] md:py-[40px] md:px-[60px] 2xl:py-[50px] 2xl:px-[80px] border-b-[1.5px] 2xl:border-b-2 border-dashed border-dark-15 ">
      ...
      {isLeftSide && (
        <div className="flex flex-col gap-[20px] md:gap-[30px] 2xl:gap-[50px]">
          <div
            className={`flex flex-col ${isGab16 ? "gap-[10px] md:gap-[12px] 2xl:gap-[16px]" : "gap-[12px] md:gap-[16px] 2xl:gap-[16px]"}`}
          >
          ...
          {isMaterial && (
            <img
              src={MaterialImg}
              alt="MaterialImg"
              className="w-full min-h-[175px] md:min-h-[311px] 2xl:min-h-[415px]"
            />
          )}
        </div>
      )}
